...
WHEN YOU ARE FINISHED YOU CAN 
  ...
  CONTENT:
  This is the interface.c file for the ScriptBasic module iodbc
----------------------------------------------------------------------------
...
/*
*TODO*
INSERT THE BASIC CODE THAT WILL GET INTO THE FILE iodbc.BAS
...
besSUB_ERRMSG
  ...
  return "Unknown iodbc module error.";
besEND
